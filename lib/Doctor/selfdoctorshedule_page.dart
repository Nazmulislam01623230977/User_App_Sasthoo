...
import 'selfappoinmentPreviewPate.dart';

class SelfghecdulePage extends StatefulWidget {
  // ignore: prefer_typing_uninitialized_variables
  var doctors;
  // ignore: prefer_typing_uninitialized_variables
  SelfghecdulePage(this.doctors, {Key key}) : super(key: key);
  @override
  _SelfShecdulePageState createState() =>
      // ignore: no_logic_in_create_state
      _SelfShecdulePageState(doctors);
}

class _SelfShecdulePageState extends StateMVC<SelfghecdulePage> {
  // ignore: prefer_typing_uninitialized_variables
  var doctors;
  // ignore: prefer_typing_uninitialized_variables

  AddPatientController con;
  _SelfShecdulePageState(this.doctors) : super(AddPatientController()) {
...
// ==========================
  ...
  appoinmentData() async {
    if (probleamController.text.isEmpty) {
      ...
      // con.placeAppoinment(userAppoinmentData, doctors, patient, context);
    }
  }
                ...
                Container(
                  ...
                  child: Row(
                    children: [
                      ...
                      Text(
                        GetuserDataFromAPi.userdata['first_name'].toString() +
                            " " +
                            GetuserDataFromAPi.userdata['last_name'].toString(),
                        style: GoogleFonts.roboto(
                ...
                Container(
                  ...
                  child: Row(
                    children: [
                      ...
                      Text(
                        GetuserDataFromAPi.userdata['date_of_birth'].toString(),
                ...
                Container(
                  ...
                  child: Row(
                    children: [
                      ...
                      Text(
                        GetuserDataFromAPi.userdata['gender'].toString(),
                        style: GoogleFonts.roboto(
                          fontWeight: FontWeight.w400,
                          fontSize: 15.sp,
                          color: const Color(0xff000000),
                  ...
                  child: Padding(
                    ...
                    child: Row(
                      children: [
                        ...
                        Text(
                          GetuserDataFromAPi.userdata['blood_group'].toString(),
                          style: GoogleFonts.roboto(
                            fontWeight: FontWeight.w400,
                            fontSize: 15.sp,
                            color: const Color(0xff000000),
