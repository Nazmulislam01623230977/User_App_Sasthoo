...
class AppoinmentPreview extends StatefulWidget {
  var doctors;
  var patients;
  ...
  _AppoinmentPreviewState createState() => _AppoinmentPreviewState(
      this.doctors, this.patients, this.userAppoinmentData, this.filesData);
}

class _AppoinmentPreviewState extends StateMVC<AppoinmentPreview> {
  var doctors;
  var patients;
  var userAppoinmentData;
  var filesData;
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            SizedBox(
                              width: 270.w,
                              child: Text(
                                "${AgeCalculator.age(DateTime.parse(patients.dateOfBirth))}",
                                style: GoogleFonts.roboto(
                                  fontSize: 15.sp,
                                  color: const Color.fromARGB(255, 0, 0, 0),
                                  fontWeight: FontWeight.w400,
