...
//
//     final doctorCancelAppoinmentForUser = doctorCancelAppoinmentForUserFromJson(jsonString);
...
List<DoctorCancelAppoinmentForUser> doctorCancelAppoinmentForUserFromJson(
        String str) =>
    List<DoctorCancelAppoinmentForUser>.from(
        json.decode(str).map((x) => DoctorCancelAppoinmentForUser.fromJson(x)));

String doctorAppoinmentForUserToJson(
        List<DoctorCancelAppoinmentForUser> data) =>
    json.encode(List<dynamic>.from(data.map((x) => x.toJson())));

class DoctorCancelAppoinmentForUser {
  DoctorCancelAppoinmentForUser({
    this.id,
    this.doctorUserId,
    this.userId,
    this.accountId,
  ...
  factory DoctorCancelAppoinmentForUser.fromJson(Map<String, dynamic> json) =>
      DoctorCancelAppoinmentForUser(
        id: json["id"],
