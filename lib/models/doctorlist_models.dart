...
List<DoctorList> doctorListFromJson(String str) =>
    List<DoctorList>.from(json.decode(str).map((x) => DoctorList.fromJson(x)));

String doctorListToJson(List<DoctorList> data) =>
