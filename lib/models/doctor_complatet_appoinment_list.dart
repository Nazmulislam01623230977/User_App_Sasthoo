...
//
//     final doctorComplatedAppoinmentForUser = doctorComplatedAppoinmentForUserFromJson(jsonString);

import 'dart:convert';

List<DoctorComplatedAppoinmentForUser> doctorComplatedAppoinmentForUserFromJson(
        String str) =>
    List<DoctorComplatedAppoinmentForUser>.from(json
        .decode(str)
        .map((x) => DoctorComplatedAppoinmentForUser.fromJson(x)));

String doctorAppoinmentForUserToJson(
        List<DoctorComplatedAppoinmentForUser> data) =>
    json.encode(List<dynamic>.from(data.map((x) => x.toJson())));

class DoctorComplatedAppoinmentForUser {
  DoctorComplatedAppoinmentForUser({
    this.id,
    this.doctorUserId,
    this.userId,
    this.accountId,
  ...
  factory DoctorComplatedAppoinmentForUser.fromJson(
